...
public class JiaxiaojiaolianController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		jiaxiaojiaolian.setClicknum(jiaxiaojiaolian.getClicknum()+1);
		jiaxiaojiaolian.setClicktime(new Date());
		jiaxiaojiaolianService.updateById(jiaxiaojiaolian);
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        JiaxiaojiaolianEntity jiaxiaojiaolian = jiaxiaojiaolianService.selectById(id);
        if(type.equals("1")) {
        	jiaxiaojiaolian.setThumbsupnum(jiaxiaojiaolian.getThumbsupnum()+1);
        } else {
        	jiaxiaojiaolian.setCrazilynum(jiaxiaojiaolian.getCrazilynum()+1);
        }
        jiaxiaojiaolianService.updateById(jiaxiaojiaolian);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,JiaxiaojiaolianEntity jiaxiaojiaolian, HttpServletRequest request,String pre){
        EntityWrapper<JiaxiaojiaolianEntity> ew = new EntityWrapper<JiaxiaojiaolianEntity>();
