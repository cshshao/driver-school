<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="驾校名称" prop="jiaxiaomingcheng">
          <el-select  @change="jiaxiaomingchengChange" v-model="ruleForm.jiaxiaomingcheng" placeholder="请选择驾校名称">
            <el-option
                v-for="(item,index) in jiaxiaomingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jiaxiaomingcheng" label="驾校名称" prop="jiaxiaomingcheng">
          ...
          <el-form-item class="input" label="教练姓名" prop="jiaolianxingming">
              <el-input v-model="ruleForm.jiaolianxingming" 
                placeholder="教练姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教练等级" prop="jiaoliandengji">
          <el-select v-model="ruleForm.jiaoliandengji" placeholder="请选择教练等级">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教练等级" prop="jiaoliandengji">
	      <el-input v-model="ruleForm.jiaoliandengji"
                placeholder="教练等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jiaolianzhaopian" label="教练照片" prop="jiaolianzhaopian">
          <file-upload
          tip="点击上传教练照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiaolianzhaopian" label="教练照片" prop="jiaolianzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiaolianzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="驾校地址" prop="jiaxiaodizhi">
              <el-input v-model="ruleForm.jiaxiaodizhi" 
                placeholder="驾校地址" readonly></el-input>
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="教练介绍" prop="jiaolianjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiaolianjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaolianjieshao" label="教练介绍" prop="jiaolianjieshao">
                    <span v-html="ruleForm.jiaolianjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jiaoliandengji : false,
	jiaolianzhaopian : false,
	lianxidianhua : false,
	jiaxiaodizhi : false,
	jiaolianjieshao : false,
	thumbsupnum : false,
	crazilynum : false,
	clicktime : false,
	clicknum : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaolianxingming = true;
            continue;
	            	            ...
	            	            if(o=='jiaoliandengji'){
            this.ruleForm.jiaoliandengji = obj[o];
	    this.ro.jiaoliandengji = true;
            continue;
          }
	    ...
	    this.ro.jiaxiaodizhi = true;
            continue;
	            	            ...
	            	            if(o=='jiaolianjieshao'){
            this.ruleForm.jiaolianjieshao = obj[o];
	    this.ro.jiaolianjieshao = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                          ...
                                          this.$http({
              url: `option/jiaxiaoxinxi/jiaxiaomingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.jiaxiaomingchengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            // 下二随
    jiaxiaomingchengChange () {
      this.$http({
        url: `follow/jiaxiaoxinxi/jiaxiaomingcheng?columnValue=`+ this.ruleForm.jiaxiaomingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                  if(data.data.jiaxiaodizhi){
                this.ruleForm.jiaxiaodizhi = data.data.jiaxiaodizhi
              }
                                                                                                                                            } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.jiaolianjieshao = this.ruleForm.jiaolianjieshao.replace(reg,'../../../ssm3j4fo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
